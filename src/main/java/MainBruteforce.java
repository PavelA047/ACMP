public class MainBruteforce {
    public static void main(String[] args) {
        ...
        long count = 2L << weights.length; // 64
        ...
        for (int i = 0; i < weights.length; i++) {
            if ((poverOfTwo & maxState) > 0) { //смотрим правильный вариант из 64, где 1 - те варианты наши
    ...
    private static int stateWeight(long state, int[] weights) {
        long poverOfTwo = 1; //дает возможность пройти в итоге по 64 вариантам и ставит номер варианта к номеру прайса
        int weight = 0;
        for (int i = 0; i < weights.length; i++) {
